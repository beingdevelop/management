...
public class LandingDrawer extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    private static final String DEBUG_TAG = "LandingDrawer";
...
//                super.onTabUnselected(tab);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logout) {
            ...
            credentialManager = new CredentialManager(LandingDrawer.this);
//            credentialManager.storeUser(credentialManager.getUserName(),null, false);
            ...
            Intent i = new Intent(LandingDrawer.this, LoginActivity.class);
            startActivity(i);
            finish();
            return true;
        }
        if (id == R.id.timeTable) {
            Intent i = new Intent(LandingDrawer.this, TimeTable.class);
            startActivity(i);
            finish();
            return true;
        }
