...
/**
 * Created by sanjay on 8/18/2016.
 */
public class AcademicCalender extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //http://scdemo.saas.talismaonline.com/MobileApp/service/ManagementService.svc/GetAcademicCalendar
        String profileUrl = "/StaffAttendanceService.svc/GetAcademicCalendar";
...
//        Toast.makeText(getContext(), "Saved Univ URL: " + credentialManager.getUniversityUrl(), Toast.LENGTH_LONG).show();
        if (networkInfo != null && networkInfo.isConnected()) {
            new AcademicCalenderTask().execute(credentialManager.getUniversityUrl() + loginURL,
    ...
    // Network code
    private class AcademicCalenderTask extends AsyncTask<String, Void, String> {
        @Override
    ...
    private void setTheNewsScreen(String result) {
        ...
        try {
            ...
            for (int i = 0; i < dataList.length(); i++) {
                ...
                View view  = inflater.inflate(R.layout.activity_academic_calender, linearLayout, false);
