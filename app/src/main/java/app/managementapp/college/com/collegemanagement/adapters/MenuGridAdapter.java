...
import app.managementapp.college.com.collegemanagement.AcademicCalender;
...
import app.managementapp.college.com.collegemanagement.TimeTable;
import app.managementapp.college.com.collegemanagement.TimeTableV2;
import app.managementapp.college.com.collegemanagement.TimeTableV3;
...
//            content = (TextView) v.findViewById(R.id.content);
    ...
    public class  ItemOnClickListener  implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            Intent i = null;
            if(position == 0) {
                i = new Intent(ctx, AcademicCalender.class);
            }
            if(position == 1){
